...
<?php include "includes/header.php"; ?>
	<section id="container">
        ...
        <br>
            ...
            <p>Atención requerida: <span><?php echo $atencion1; ?></span></p>
            <p>Remisión: <span><?php echo $remision; ?></span></p>



            <form method ="post" action="">
                <input type="hidden" name="id_persona" value="<?php echo $id_persona; ?>">
                <a href="lista_rutas.php" class="btn_cancel"> <i class="fas fa-ban"></i> Cancelar</a>
