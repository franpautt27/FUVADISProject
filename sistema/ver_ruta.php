	...
	<section id="container">
        ...
        <div class="form_register2">
            ...
            <tr>
                ...
                <input type="text" id="atencion1" name="atencion1" value="<?php echo $atencion1;?>" disabled> <br>
      
                <br>                
                <label for ="atencion2">Segunda atencion requerida: </label>     
                <input type="text" id="atencion2" name="atencion2"   value="<?php echo $atencion2;?>" disabled> <br>
               ...
               <br>                
                   ...
                   <input type="text" id="atencion3" name="atencion3"  value="<?php echo $atencion3;?>" disabled> <br>
       
                 <br>                
                <label for ="remision">Remision a:</label>
                <input type="text" id="remision" name="remision"    value="<?php echo $remision;?>" disabled> <br>
                ...
                <textarea class ="textarea1"  disabled  name="observaciones" id="observaciones" cols="100" rows="10" > <?php echo $observaciones;?> </textarea> <br>
                     
               
                <button type="submit" class="btn_save2"> <i class="fas fa-plus-square"></i> Volver</button>  
            </form>
        </div>
