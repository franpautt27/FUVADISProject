<section id="container">
        ...
        <div class="form_register2">
            ...
            <h1>Encuesta de Vulnerabilidad - FUVADIS</h1>
            <hr>
            <div class="alert"> <?php echo isset($alert) ? $alert : ''; ?> </div>

            <form action= <?php echo $accion; ?>  method="post" class="formulario">
            <table id="space">            
            <tr>
                            <td>
                ...
                <input type="text" name="segundo_nombre" placeholder="Segundo Nombre"  required> <br>
                ...
                <input type="text" name="segundo_apellido" placeholder="Segundo Apellido" required > <br>
                ...
                <label for ="motivo1">¿Cuál es el principal motivo por el que consulta a FUVADIS?</label>
                <select name="motivo1" required >
                <option disabled selected value> -- seleccione una opcion -- </option>
                ...
                <label for ="motivo2">¿Cuál es el segundo motivo por el que consulta a FUVADIS? (opcional)</label> 
                <select name="motivo2"  >
                ...
                <label for ="motivo3">¿Cuál es el tercer motivo por el que consulta a FUVADIS? (opcional)</label>
                <select name="motivo3"  >
                <option value=""> -- seleccione una opcion -- </option>
                <option value="Orientación Migratoria">Orientación Migratoria</option>
                    <option value="Acceso a salud">Acceso a salud</option>
                ...
                <p><b>Estatus regular:</b> cuenta con la documentación requerida para estar de forma legal en el país</p>
                <p><b>Estatus Irregular:</b> NO cuenta con la documentación requerida para estar de forma legal en el país</p>
                <select name="estatus_migratorio" required >
                <option disabled selected value> -- seleccione una opcion -- </option>
                ...
                <option disabled selected value> -- seleccione una opcion -- </option>
                    <optgroup label="Documentos venezolanos">
                        <option value="Cédula venezolana">Cédula Venezolana</option>
                    </optgroup>

                    <optgroup label="Documentos para migrantes">
                        <option value="PEP">PEP</option>
                        <option value="PEP RAMV">PEP RAMV</option>
                        <option value="Salvo conducto">Salvo conducto</option>
                        <option value="Pasaporte">Pasaporte</option>

                    </optgroup>
                    <optgroup label="Documentos colombianos">
                ...
                <label for ="num_documento">Número de documento:</label>
                 <p>En caso de haber puesto "Sin documentos", rellenar con un 0.</p>
                <input type="number" name= "num_documento" placeholder="Número de documento" required> <br>
                ...
                <select name="forma_empleo" required >
                <option disabled selected value> -- seleccione una opcion -- </option>
                ...
                <select name="rango_ingresos" required  >
                <option disabled selected value> -- seleccione una opcion -- </option>
                ...
                <select name="num_comidas_dias"  required>
                <option disabled selected value> -- seleccione una opcion -- </option>
                   ...
                   <p><b>LGBTI:</b> Lesbianas, gays, transexuales e intersexuales.</p>
                   <div class="radio">
                <input type="radio" name="lgbti" value="Sí"   id="si" required> 
                <label for="si">Sí</label> 
                <input type="radio" name="lgbti" value="No"   id="no" required> 
                ...
                <div class="radio">
                <input type="radio" name="trabajo_sexual" value="Sí"   id="si2" required>
                <label for="si2">Sí</label> 
                <input type="radio" name="trabajo_sexual" value="No"   id="no2" required>
                ...
                <select name="condicion_salud"  required>
                <option disabled selected value> -- seleccione una opcion -- </option>
                ...
                <input type="text" name="barrio"   placeholder="Barrio o Localidad" required> <br>
                <label for ="situacion_vivienda">Situación en la que habita:</label>
                <select name="situacion_vivienda" required >
                <option disabled selected value> -- seleccione una opcion -- </option>
                ...
                <label for ="telefono2">Teléfono celular o fijo alterno:</label>
                 <p>En caso de no tener, rellenar con un 0.</p>
                <input type="number" id="telefono2" name="telefono2" placeholder="Teléfono" required> <br>
                <label for ="n_family">Número de integrantes de su familia incluído usted:</label>
                <input type="range" name="num_family" class="slider" min="1" max="20" value="0" oninput="n_family.value=this.value"  />
                <input type="number" name="n_family" min="1" max="20" value="0" oninput="num_family.value=this.value"  required/> <br>
                <label for ="n_ninos">Número de niños dentro del núcleo familiar:</label>
                <input type="range" name="num_ninos" class="slider" min="0" max="20" value="0" oninput="n_ninos.value=this.value" />
                <input type="number" name="n_ninos" min="0" max="20" value="0" oninput="num_ninos.value=this.value" required/> <br>
                <label for ="n_mayores">Número de adultos mayores dentro del núcleo familiar:</label>
                <input type="range" name="num_mayores" class="slider" min="0" max="20" value="0" oninput="n_mayores.value=this.value" />
                <input type="number" name="n_mayores" min="0" max="20" value="0" oninput="num_mayores.value=this.value" required/> <br>
                <label for ="n_gestantes">Número de mujeres gestantes o lactantes dentro del núcleo familiar:</label>
                <p><b>Mujer Gestante:</b> Mujer en estado de embarazo</p>
                <input type="range" name="num_gestantes" class="slider" min="0" max="20" value="0" oninput="n_gestantes.value=this.value" />
                <input type="number" name="n_gestantes" min="0" max="20" value="0" oninput="num_gestantes.value=this.value" required/> <br>
                
                <label for ="n_discapacitados">Número de personas con discapacidad dentro del núcleo familiar:</label>
                <input type="range" name="num_discapacitados" class="slider" min="0" max="20" value="0" oninput="n_discapacitados.value=this.value" />
                <input type="number" name="n_discapacitados" min="0" max="20" value="0" oninput="num_discapacitados.value=this.value" required/> <br>
                <label for ="necesidad1">¿Cuál es la primera necesidad que más se asocia con su situación?</label>
                <select name="necesidad1" required  >
                <option disabled selected value> -- seleccione una opcion -- </option>
                <option value="Persona con discapacidad">Persona con discapacidad</option>
                    <option value="Condición médica grave">Condición médica grave</option>
                    <option value="Estrés emocional">Estrés emocional</option>
                    <option value="Sobreviviente VSBG">Sobreviviente VSBG</option>
                    <option value="Mujer en Riesgo">Mujer en Riesgo</option>
                    <option value="Victima de trata">Victima de trata</option>
                    <option value="Sin Documentacion legal">Sin Documentacion legal</option>
                    <option value="Protección legal y/o física">Protección legal y/o física</option>
                    <option value="Niño/adolescente en riesgo">Niño/adolescente en riesgo</option>
                    <option value="Cabeza de familia">Cabeza de familia</option>
                    <option value="Mujer en Lactancia">Mujer en Lactancia</option>
                    <option value="Persona mayor en riesgo">Persona mayor en riesgo</option>
                ...
                <label for ="lgbti">Acepta usted el tratamiento de sus datos personales acorde a la Ley 1581 de 2012 (debe aceptar esta condicion para continuar)</label>
                   <div class="checkbox">
                <input type="checkbox" name="ley_datos" value="Acepto"   id="acepto" required> 
                <label for="acepto">Acepto</label></div>       
                </td>
                   <tr>
                   </table> 
                   <label for ="descripcion">Descripción del motivo por el cual consulta a FUVADIS:</label> <br>       
                <textarea class ="textarea1" name="descripcion" id="descripcion" cols="100" rows="10"   placeholder="Descripción..." required></textarea> <br>
                
               
                <input type="submit" value="Enviar" class="btn_save2">   
            </form>
        </div>
